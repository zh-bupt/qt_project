...
QT_MOC_LITERAL(1, 13, 28), // "on_order_table_doubleClicked"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 5), // "index"
QT_MOC_LITERAL(4, 49, 29) // "on_borrow_table_doubleClicked"

    },
    "MessageBoard\0on_order_table_doubleClicked\0"
    "\0index\0on_borrow_table_doubleClicked"
};
...
void MessageBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_order_table_doubleClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 1: _t->on_borrow_table_doubleClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject MessageBoard::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_MessageBoard.data,
      qt_meta_data_MessageBoard,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MessageBoard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MessageBoard.stringdata0))
        return static_cast<void*>(const_cast< MessageBoard*>(this));
