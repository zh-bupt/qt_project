...
QT_MOC_LITERAL(3, 23, 10) // "changeFlag"

    },
    "TimeThread\0TestSignal\0\0changeFlag"
};
...
void TimeThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TimeThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TimeThread::TestSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TimeThread::TestSignal(QString _t1)
{
