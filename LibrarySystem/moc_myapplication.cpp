...
QT_MOC_LITERAL(1, 14, 8), // "hasInput"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "MyApplication\0hasInput\0"
};
...
void MyApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MyApplication::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyApplication::hasInput)) {
                *result = 0;
                return;
            }
        }
